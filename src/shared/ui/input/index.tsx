/** biome-ignore-all lint/suspicious/noControlCharactersInRegex: intentional suppression */
    ...
    return (
        ...
        >
            ...
            <div className={css.inputWrapper}>
                {leftIcon && (
                    <span className={`${css.icon} ${css.iconLeft}`}>
                        {leftIcon}
                    </span>
                )}
                ...
                {rightIcon && (
                    <span className={`${css.icon} ${css.iconRight}`}>
                        {rightIcon}
                    </span>
                )}
