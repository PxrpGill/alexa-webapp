...
import type { FooterNavListProps } from "../ui/footer/footer-nav-list";
...
export const CHILD_STOM_NAV: FooterNavListProps = {
...
export const ADULT_STOM_NAV: FooterNavListProps = {
...
export const STOM_INFO: FooterNavListProps = {
	title: "Информация",
	list: [
		{
			title: "О&nbsp;клинике",
...
export const VOLKOVA_NAVIGATION = [STOM_INFO];

export const FOOTER_DICT_NAVIGATION = {
	landyshevaya: LANDYSHEVAYA_NAVIGATION,
	volkova: VOLKOVA_NAVIGATION,
};
