...
export const DESCRIPTION_SECTION: DescriptionSectionProps = {
    title: "Начните путь к&nbsp;здоровой улыбке вашего <span style='color: var(--color-green-1);'>ребёнка с&nbsp;первой консультации</span>",
    description:
    ...
    cards: [
        {
            ...
            description:
                'Проводится осмотр полости рта и&nbsp;зубов вашего ребенка.',
        },
        {
