...
export const COST_OF_SERVICES: CostOfServicesProps = {
    ...
    cards: [
        ...
        {
            title: 'Цельнокерамическая коронка на&nbsp;импланте на&nbsp;титановом абатменте стандартное исполнение',
            button: {
                title: 'Получить консультацию',
                href: '',
            },
        ...
        {
            title: 'Реставрация цельнокерамическая (вкладка/накладка) 3D&nbsp;Medit 500',
            button: {
                title: 'Получить консультацию',
                href: '',
            },
