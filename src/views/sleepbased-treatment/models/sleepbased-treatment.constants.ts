...
export const QUADRO_MOCK: QuadroSectionProps = {
    sectionHeader: {
        ...
        card: {
            title: 'Подарите себе и&nbsp;ребенку спокойствие&nbsp;&mdash; запишитесь на&nbsp;консультацию и&nbsp;узнайте, подходит&nbsp;ли лечение во&nbsp;сне именно вам.',
...
export const BRICKWORK_MOCK_SECTION: BrickworkSectionProps = {
    ...
    cards: [
        ...
        },
        {
            ...
            description:
                'Процедура проводится под контролем опытных анестезиологов.',
        },
        {
            icon: '/mock/sleepbased-treatment/4-icon.svg',
    ...
    cards: [
        {
            ...
            answer: 'Да, седация и&nbsp;наркоз проходят под контролем опытных врачей. Мы&nbsp;применяем только проверенные препараты, одобренные для детской стоматологии.',
        },
        {
            question: 'В&nbsp;каком возрасте можно лечить зубы во&nbsp;сне?',
            answer: 'Седация возможна с&nbsp;0&nbsp;лет (но&nbsp;по&nbsp;показаниям врача), а&nbsp;общий наркоз&nbsp;&mdash; по&nbsp;показаниям и&nbsp;после оценки состояния ребёнка. Решение принимает врач после личной консультации.',
        },
        {
            question: 'Ребёнок будет спать или всё чувствовать?',
            answer: 'При седации ребёнок остаётся в&nbsp;сознании, но&nbsp;расслаблен и&nbsp;не&nbsp;ощущает тревоги. При наркозе&nbsp;&mdash; полностью спит. Метод подбирается индивидуально, в&nbsp;зависимости от&nbsp;сложности лечения и&nbsp;возраста.',
        },
        {
            question: 'Сколько длится восстановление?',
            answer: 'После седации ребёнок приходит в&nbsp;себя уже через 10&ndash;15 минут и&nbsp;может вернуться к&nbsp;обычному режиму. После наркоза восстановление занимает немного больше времени, но&nbsp;проходит под наблюдением.',
        },
        {
            question: 'А&nbsp;если нужно вылечить сразу несколько зубов?',
            answer: 'Лечение во&nbsp;сне позволяет за&nbsp;одно посещение вылечить даже несколько зубов, что особенно удобно для детей с&nbsp;множественными кариесами или страхом перед врачами.',
        },
        {
            question: 'Как подготовиться к&nbsp;лечению во&nbsp;сне?',
            answer: 'Перед процедурой нужно пройти консультацию со&nbsp;стоматологом и&nbsp;с&nbsp;анестезиологом, сдать анализы. Врач даст четкие рекомендации по&nbsp;питанию, питью и&nbsp;поведению в&nbsp;день лечения.',
        },
    ],
};
...
export const PROMO_SECTION_MOCK: PromoSectionProps = {
    ...
    cards: [
        ...
        {
            title: 'Подойдет&nbsp;ли вашему ребёнку седация&nbsp;&mdash; определит врач',
            content:
