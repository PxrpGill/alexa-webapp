...
export const EMPLOYEES_SECTION: OurPeopleSectionProps = {
	...
	employees: [GLOBAL_EMPLOYEES.kaplin, GLOBAL_EMPLOYEES.shahnazaryan],
};
...
export const COST_OF_SERVICES: CostOfServicesProps = {
	...
	cards: [
		{
			title: "Удаление зуба 1&nbsp;степени сложности",
			description:
				"<p>Обезболивание, очищение лунки (по&nbsp;показаниям), послеоперационная обработка, остановка кровотечения и&nbsp;рекомендации по&nbsp;уходу после удаления.</p>",
			button: COSTS_OF_SERVICES_BUTTON,
			price: 5_100,
		},
		{
			title: "Удаление зуба 2&nbsp;степени сложности",
			description:
				"<p>Обезболивание, удаление зуба с&nbsp;механическим секционированием, очищение лунки (по&nbsp;показаниям), ушивание раны (по&nbsp;показаниям), рекомендации по&nbsp;уходу после удаления и&nbsp;снятие швов.</p>",
			button: COSTS_OF_SERVICES_BUTTON,
			price: 7_200,
		},
		{
			title: "Удаление верхнего зуба мудрости",
			description:
				"<p>Обезболивание, механическое секционирование, очищение лунки, костнопластический материал (по&nbsp;показаниям, оплачивается отдельно), ушивание раны (по&nbsp;показаниям), рекомендации по&nbsp;уходу, назначение лечения и&nbsp;снятие швов.</p>",
			button: COSTS_OF_SERVICES_BUTTON,
			price: 8_300,
		},
		{
			title: "Удаление нижнего зуба мудрости",
			description:
				"<p>Обезболивание, механическое секционирование, очищение лунки, костнопластический материал (по&nbsp;показаниям, оплачивается отдельно), ушивание раны (по&nbsp;показаниям), рекомендации по&nbsp;уходу, назначение лечения и&nbsp;снятие швов.</p>",
			button: COSTS_OF_SERVICES_BUTTON,
			price: 11_000,
		...
		{
			title:
				"Сложное удаление ретенированных/дистопированных зубов верхней челюсти",
			description:
				"<p>Обезболивание, механическое секционирование, очищение лунки, костнопластический материал (по&nbsp;показаниям, оплачивается отдельно), ушивание раны (по&nbsp;показаниям), рекомендации по&nbsp;уходу и&nbsp;снятие швов.</p>",
			button: COSTS_OF_SERVICES_BUTTON,
			price: 15_350,
		},
		{
			title:
				"Сложное удаление ретенированных/дистопированных зубов нижней челюсти",
			description:
				"<p>Обезболивание, механическое секционирование, очищение лунки, костнопластический материал (по&nbsp;показаниям, оплачивается отдельно), ушивание раны (по&nbsp;показаниям), рекомендации по&nbsp;уходу и&nbsp;снятие швов.</p>",
			button: COSTS_OF_SERVICES_BUTTON,
			price: 20_200,
		...
		{
			title: "Установка имплантата Straumann (Швейцария), 1 шт.",
			description:
				"<p>Анестезия, установка имплантата системы Straumann (Швейцария), имплантат и&nbsp;заглушка.</p>",
			button: COSTS_OF_SERVICES_BUTTON,
			price: 72_950,
		},
		{
			title:
				"Установка имплантата Straumann Group (Швейцария), MEDENTIKA, 1 шт.",
			description:
				"<p>Анестезия, установка имплантата системы Straumann Group (Швейцария), MEDENTIKA, имплантат и&nbsp;заглушка.</p>",
			button: COSTS_OF_SERVICES_BUTTON,
			price: 40_950,
			priceType: "from",
		},
...
export const IMPLANT_TABLE: ImplantTableProps = {
	sectionHeader: {
		title: "Какой имплант выбрать?<br /> Сравниваем для вас",
		description:
