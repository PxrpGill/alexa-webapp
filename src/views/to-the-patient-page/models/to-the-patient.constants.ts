...
export const DOCUMENTS_MOCK: DocumentsListProps = {
    documents: [
        ...
        {
            title: 'Порядок оказания медицинской помощи в&nbsp;рамках Территориальной программы (ОМС)',
            href: '/documents/Порядок_оказания_медицинской_помощи_в_рамках_Территориальной_программы.docx',
        },
        {
            title: 'Гарантийные обязательства и&nbsp;сроки гарантии на&nbsp;стоматологические услуги',
            href: '/documents/Приложение 1. Гарантии.docx',
        },
        {
            title: 'Постановление Об&nbsp;утверждении Правил предоставления медицинскими организациями платных мед. услуг',
