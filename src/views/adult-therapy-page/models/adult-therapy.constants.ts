...
export const TITLE_STICKY_SECTION_MOCK: TitleStickySectionProps = {
    ...
    cards: [
        {
            title: 'Хотите восстановить форму и&nbsp;функцию поврежденных зубов с&nbsp;помощью пломбирования или реставрации.',
        },
        {
            title: 'Боитесь стоматологических процедур и&nbsp;желаете провести лечение под общим наркозом или седацией.',
        },
        {
            title: 'Заметили потемнение эмали, дырку в&nbsp;зубе или чувствительность к&nbsp;холодному/горячему.',
        },
...
export const BRICKWORK_SECTION_MOCK: BrickworkSectionProps = {
    ...
    cards: [
        ...
        },
        {
            ...
            title: 'Специальные кресла KaVo ESTETICA<sup class="reg">&reg;</sup> E30&nbsp;S:',
            description:
...
export const COST_OF_SERVICES: CostOfServicesProps = {
    ...
    cards: [
        ...
        {
            title: 'Эндодонтическое лечение корневых каналов (1&nbsp;или 2&nbsp;канала)',
            description:
