...
export const GREEN_CTA: CtaGreenProps = {
    title: 'Регулярный контроль состояния зубов, профессиональная гигиена и&nbsp;профилактика помогают сохранять здоровье полости рта и&nbsp;уверенность в&nbsp;улыбке каждый день.',
};
...
export const QAUDRO_MOCK: QuadroSectionProps = {
    sectionHeader: {
        ...
        card: {
            title: 'Наша клиника предлагает комплексный подход, который защитит вас от&nbsp;боли и&nbsp;лишних трат.',
        },
        poster: {
            webp: {
...
export const STOMATOLOGY_PROGRAM: StomatologyProgramProps = {
    ...
    ctaBlock: {
        title: 'На&nbsp;основе диагностики формируется индивидуальный план сохранения здоровья зубов на&nbsp;год.',
        button: {
...
export const PREVENTION_SECTION: PreventionSectionProps = {
    sectionHeader: {
        title: '90% стоматологических проблем можно обнаружить до&nbsp;появления боли.',
    },
    content:
