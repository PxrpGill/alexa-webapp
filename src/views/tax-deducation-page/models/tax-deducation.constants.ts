...
export const DESCRIPTION_SECTION_MOCK: DescriptionCardProps = {
    title: 'Вы&nbsp;можете оформить налоговый вычет за&nbsp;лечение, полученное в&nbsp;нашей клинике.<br /> Мы&nbsp;постарались сделать этот процесс максимально удобным для вас.',
};
...
export const ALGORITHM_OF_ACTIONS_MOCK: AlgorithmOfActionsProps = {
    ...
    cta: {
        title: 'Если у&nbsp;вас возникли вопросы&nbsp;&mdash; наши администраторы всегда на&nbsp;связи и&nbsp;с&nbsp;радостью помогут',
        button: {
